    ...
    return (
        <div className="user">
            ...
            <div className="sticky-top user-nav px-4 d-flex align-items-center" style={{ height: '8vh' }}>
                ...
                {
                    toggleNav ? (
                        <button className="ms-1 btn border-0 rounded-0 p-0" onClick={() => setToggleNav(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5" />
                            </svg>
                        </button>
                    ) : (
                        <button className="ms-1 btn border-0 rounded-0 p-0" onClick={() => setToggleNav(true)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5" />
                            </svg>
                        </button>
                ...
                {
                    showUser ? (
                        <button className="btn border-0 ms-auto d-flex align-items-center gap-2 user-name py-0" onClick={() => setShowUser(false)}>
                        ...
                        <button className="btn border-0 ms-auto d-flex align-items-center gap-2 user-name py-0" onClick={() => setShowUser(true)}>
            ...
            <div className="main-area d-flex">
                ...
                <div className="content">
                    <div className={`${ showContent === 1 ? "d-block" : "d-none"} h-75 bg-info`}>
                        <div className="d-flex justify-content-center">Lectures Here</div>
                    </div>
                    <div className={`${ showContent === 2 ? "d-block" : "d-none"} h-50 bg-warning`}>
                        <div className="d-flex justify-content-center">Quiz Here</div>
                    </div>
                    <div className={`${ showContent === 3 ? "d-block" : "d-none"} h-25 bg-secondary`}>
                        <div className="d-flex justify-content-center">Tests Here</div>
                    </div>
                </div>
            </div>
        </div>
